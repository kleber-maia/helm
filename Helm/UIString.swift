...
public struct UIString: RawRepresentable, Sendable
{
  ...
  enum ItemType
  {
    ...
    static let localBranch = ›"local branch"
  ...
  static private let confirmDeleteBranchAndRemoteFormat = "Delete local branch \"%1$@\" and its remote branch on %2$@?"
  ...
  static func confirmDeleteBranchAndRemote(branch: String, remote: String) -> UIString
  { .init(format: UIString.confirmDeleteBranchAndRemoteFormat, branch, remote) }
  ...
  static let remoteBranchNotDeleted = ›"The remote tracking branch will not be deleted."
  static let deleteBranchAndRemote = ›"Delete branch and remote..."
  static let deleteBranchAndRemoteInfo = ›"This will delete both the local branch and its remote tracking branch."
