...
extension HelmRepository: CommitStorage
{
  ...
  {
    performReading {
      GitCommit(oid: oid, repository: gitRepo)
    }
  }
  ...
  {
    GitRevWalk(repository: gitRepo, lock: mutex)
  }
}

extension HelmRepository: CommitReferencing
{
