...
{
  associatedtype Commit: Helm.Commit
  associatedtype RevWalk: Helm.RevWalk
...
{
  associatedtype Commit: Helm.Commit
  associatedtype Tag: Helm.Tag
  associatedtype Tree: Helm.Tree
  associatedtype LocalBranch: Helm.LocalBranch
  associatedtype RemoteBranch: Helm.RemoteBranch
...
public class FakeCommitReferencing<
    Commit: Helm.Commit,
    Tree: Helm.Tree,
    LocalBranch: Helm.LocalBranch,
    RemoteBranch: Helm.RemoteBranch>: CommitReferencing
{
...
{
  associatedtype Blame: Helm.Blame
...
public protocol FileContents: AnyObject
{
  ...
  func contentsOfFile(path: String, at commit: any Helm.Commit) -> Data?
...
{
  associatedtype Stash: Helm.Stash
...
{
  associatedtype Remote: Helm.Remote
  ...
  /// Deletes a remote branch by pushing a delete refspec.
  /// - parameter branch: The remote branch to delete.
  /// - parameter remote: The remote to push the deletion to.
  /// - parameter callbacks: Password and progress callbacks.
  func deleteRemoteBranch(named branch: RemoteBranchRefName,
                          remote: Remote,
                          callbacks: RemoteCallbacks) throws
}
...
{
  public typealias PasswordBlock = () -> (String, String)?
  public typealias DownloadProgressBlock = (any TransferProgress) -> Bool
  public typealias UploadProgressBlock = (PushTransferProgress) -> Bool
  public typealias SidebandMessageBlock = (String) -> Bool
...
public protocol Branching: AnyObject
{
  ...
  func reset(toCommit target: any Helm.Commit, mode: ResetMode) throws
}
