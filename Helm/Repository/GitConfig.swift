...
public extension Config
{
  ...
  func fetchTags(remote: String) -> Bool
  {
    ...
    return UserDefaults.helm.bool(forKey: PreferenceKeys.fetchTags)
  }
...
public final class GitConfig: Config
{
  ...
  /// Adds an app-level config file for settings changed by Helm.
  ///
  ...
  private func addAppConfig() throws
  {
    ...
    let configURL = appSupport.appendingPathComponent("helm.gitconfig")
