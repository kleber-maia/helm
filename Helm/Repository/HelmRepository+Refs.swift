...
extension HelmRepository: Branching
{
    ...
    -> GitLocalBranch?
  {
    ...
    for entry in config.entries {
      let name = entry.name
      guard let match = HelmRepository.remoteRegex
  ...
  public func reset(toCommit target: any Helm.Commit, mode: ResetMode) throws
  {
...
extension HelmRepository: Tagging
{
