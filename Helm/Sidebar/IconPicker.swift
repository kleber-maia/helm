...
enum PreviewSidebarTab: TabItem
{
  case branches, remotes, tags

  var icon: some View
  {
    switch self {
      case .branches: Image(systemName: "externaldrive")
...
struct IconTabPicker_Preview: View {
  let showsDividers: Bool
  @State var selection: PreviewSidebarTab = .branches

  var body: some View {
    IconPicker(items: [.branches, .remotes, .tags],
               selection: $selection,
