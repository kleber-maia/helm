...
enum PreferenceKeys
{
  ...
  static let editorLightTheme = PreferenceKey("editorLightTheme",
                                               "xcode-light")
...
extension UserDefaults
{
  ...
  static var testing: UserDefaults = {
    let result = UserDefaults(suiteName: "helm-testing")!
    result.removePersistentDomain(forName: "helm-testing")
    return result
  }()
  ...
  @objc dynamic var editorLightTheme: String
  {
    get { self[PreferenceKeys.editorLightTheme] }
    set { self[PreferenceKeys.editorLightTheme] = newValue }
  }
  @objc dynamic var editorDarkTheme: String
  {
    get { self[PreferenceKeys.editorDarkTheme] }
    set { self[PreferenceKeys.editorDarkTheme] = newValue }
  }
...
extension Config
{
  var codingAgent: CodingAgent?
  {
    get { self["helm.codingagent"].flatMap { CodingAgent(rawValue: $0) } }
    set { self["helm.codingagent"] = newValue?.rawValue }
  }
}
