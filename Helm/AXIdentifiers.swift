...
extension AXID
{
  ...
  enum Sidebar
  {
    ...
    static let tree = AXID("sidebarTree")
    static let sectionBranches = AXID("sidebarSectionBranches")
    static let sectionRemotes = AXID("sidebarSectionRemotes")
    static let sectionTags = AXID("sidebarSectionTags")
    static let sectionStashes = AXID("sidebarSectionStashes")
    static let sectionSubmodules = AXID("sidebarSectionSubmodules")
